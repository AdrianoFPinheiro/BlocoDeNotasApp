package br.com.adrianofpinheiro.blocodenotasapp.repository

import br.com.adrianofpinheiro.blocodenotasapp.api.getNotaAPI
...
class NotaRepository {
    ...
    fun buscarTodos(onComplete: (List<Nota>?) -> Unit,
